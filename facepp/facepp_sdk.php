...
class Facepp
{
    ...
    public $api_key         = '97a4207888bab3aa50523ae2a8032f78';        // set your API KEY or set the key static in the property
    public $api_secret      = 'fQsSA66lJ2y7p56oJN2Fa60oTOdIQ-u-';        // set your API SECRET or set the secret static in the property
